...
/**
 * Доход, уже выплаченный на свободный баланс. В проде — сумма транзакций
 * типа «выплата» за всё время, здесь зафиксирован в мок-слое.
 */
export const paidOutProfit = 18_640

export const EARN_APY = 7

/** Средняя целевая доходность инвестпрограмм — для сравнения с Earn на дашборде. */
export const PROGRAM_APY = 12
