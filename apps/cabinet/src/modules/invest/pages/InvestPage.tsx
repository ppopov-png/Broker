...
const PRODUCTS: Product[] = [
  {
    ...
    risk: 'Низкий риск', description: 'Бессрочное размещение: заводите в любой момент, начисление идёт каждый день.', terms: [], openEnded: true, payout: 'по запросу, раз в месяц', payoutMonths: 1, min: 1000, topup: 'в любой момент', withdraw: 'раз в неделю', tags: ['Без срока', 'Начисление каждый день'],
  ...
  },
  {
    ...
    risk: 'Умеренный риск', description: 'Сбалансированный рост: управляемая стратегия Trigonum с горизонтом от трёх месяцев.', terms: [3, 6, 12], payout: 'раз в квартал', payoutMonths: 3, min: 1000, topup: 'в любой момент', withdraw: 'в конце срока', tags: ['Сбалансированный рост', 'Срок 3–12 мес.'],
  ...
  },
  {
    ...
    risk: 'Высокий риск', description: 'Агрессивный рост: активное управление с повышенной волатильностью результата.', terms: [3, 6, 12], payout: 'раз в полгода', payoutMonths: 6, min: 1000, topup: 'в любой момент', withdraw: 'в конце срока', tags: ['Агрессивный рост', 'Срок 3–12 мес.'],
