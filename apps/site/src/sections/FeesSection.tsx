...
/**
 * Комиссии открытым блоком, а не сноской в подвале. Список «чего не берём»
 * отличает нас от площадок, где комиссия обнаруживается при выводе.
 */
      ...
      <div className="fees-layout">
        <div className="fees-table-wrap">
          <table className="fees-table">
            <thead>
              <tr>
                <th>{fees.columns.product}</th>
                <th>{fees.columns.management}</th>
                <th>{fees.columns.result}</th>
              </tr>
            </thead>
            <tbody>
              {fees.rows.map((row) => (
